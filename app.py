...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('postgresql://pythondb_jrac_user:7jsGVIrSNl8YrYorlAC6J8dduBFXxapZ@dpg-d0aarl8gjchc73c8ejfg-a.oregon-postgres.render.com/pythondb_jrac')
